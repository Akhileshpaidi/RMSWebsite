...
@Component({
  selector: 'app-edit-act-rule-regulation',
  templateUrl: './edit-act-rule-regulation.component.html',
  styleUrls: ['./edit-act-rule-regulation.component.scss']
})
export class EditActRuleRegulationComponent {
...
replacedFiles:any=[];
  ...
  this.UpdateForm = this.formBuilder.group({
    ...
    type_bussiness:[''],
    bussiness_operations:[''],
    no_of_employees:[''],
    bussiness_investment:[''],
    bussiness_turnover:[''],
    working_conditions:[''],
...
retrieveFiles(act_rule_regulatory_id: any): void {
  this.http.get(`${BASE_URL}/actruleregulations/GetactruleregulationsDetailsnyid/${act_rule_regulatory_id}`)
  .subscribe((data: any) => {
...
get references(): FormArray {
 ...
 if (act_rule_regulatory_file_id == 0) {
  ...
  if (act_rule_regulatory_file_id !== 0) {
    alert(act_rule_regulatory_file_id)
        // If bare_act_id is not 0, make an HTTP POST request to remove the file
    this.http.post(`${BASE_URL}/rulesandregulatory/removerulesandregulatory/${act_rule_regulatory_file_id}`, {})
      .subscribe(
        (data: any) => {
  ...
  }  else  if (act_rule_regulatory_file_id == 0){
    this.references.removeAt(index);
  }
 // this.references.removeAt(index);
  }
  ...
  SubmitUpdateForm(): void {
    ...
    if (this.UpdateForm.valid) {
     ...
     // alert('About to submit form data to API. Confirm?');
      ...
      this.http.post(`${BASE_URL}/actruleregulations/UpdateActRuleRegulatory`, formData, {
      ...
      .subscribe(response => {
        ...
        this.erroMessage ="Rule/Regulation Updated  successfully";
       ...
       // alert('Rule/Regulation Updated  successfully!');
        this.router.navigate(['/dashboard/Actregulation/ViewActrulesregulations']);
      }, error => {
