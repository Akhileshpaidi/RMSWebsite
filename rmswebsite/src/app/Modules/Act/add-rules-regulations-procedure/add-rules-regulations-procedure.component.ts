...
@Component({
  selector: 'app-add-rules-regulations-procedure',
  templateUrl: './add-rules-regulations-procedure.component.html',
  styleUrls: ['./add-rules-regulations-procedure.component.scss']
})
export class AddRulesRegulationsProcedureComponent {
  yourform: FormGroup;
  addrules: any;
  actname:any;
  categorylaw:any;
...
//alert(JSON.stringify(formData))
    ...
    // }
      ...
      this.http.post(URL + '/ActRegulatory/InsertRuleActRegulatory', formData)
