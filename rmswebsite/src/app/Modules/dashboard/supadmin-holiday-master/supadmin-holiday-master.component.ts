...
@Component({
  selector: 'app-supadmin-holiday-master',
  templateUrl: './supadmin-holiday-master.component.html',
  styleUrls: ['./supadmin-holiday-master.component.scss']
})
export class SupadminHolidayMasterComponent {
  dataSource2: any;
  userdata: any;
  typedata: any;
 ...
 SubTypeinfo: hoildasymaster= new hoildasymaster();
  ...
  constructor(private http: HttpClient, private session: SessionService) {
    ...
    this.dataSource2 = new CustomStore({
      ...
      load: () => this.sendRequest1(URL + '/SupAdminHolidayMaster/GetHolidayMasterDetails'),
      
      insert: (values) => this.sendRequest1(URL + '/SupAdminHolidayMaster/InsertHolidayMasterDetails', 'POST', {
          // values: JSON.stringify(values)
          values
      }),
      update: (key, values) => this.sendRequest1(URL + '/SupAdminHolidayMaster/UpdateHolidayMasterDetails', 'PUT', {
           key,
          //  values: JSON.stringify(values)
          values
       }),
       remove: (key) => this.sendRequest1(URL + '/SupAdminHolidayMaster/DeleteHolidayMasterDetails', 'DELETE', {
           key
       })
