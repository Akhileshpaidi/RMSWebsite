...
@Component({
  selector: 'app-compliance-penalty-master',
  templateUrl: './compliance-penalty-master.component.html',
  styleUrls: ['./compliance-penalty-master.component.scss']
})
export class CompliancePenaltyMasterComponent implements OnInit {
  yourform: FormGroup;
 ...
 showInvalidFieldsAlert() {
  ...
  onSubmit() {
    ...
    if (this.compliancepenalty.valid) {
      ...
      this.http.post(URL + '/penaltycategory/InsertCompliancepenaltycategorydetails', formData,{headers})
