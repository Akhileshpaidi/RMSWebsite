...
import { risk_admin_likeoccfact, risk_natureof_cont_occu, riskImpactRating, RiskLikelihood} from '../../../inspectionservices.service';
...
@Component({
  selector: 'app-risk-admin-risk-like-of-occu-factor',
  templateUrl: './risk-admin-risk-like-of-occu-factor.component.html',
  styleUrls: ['./risk-admin-risk-like-of-occu-factor.component.scss']
})
export class RiskAdminRiskLikeOfOccuFactorComponent {
  ...
  value:any;
  userdata:any;
  riskCatlev:risk_admin_likeoccfact=new risk_admin_likeoccfact();

  constructor(private http: HttpClient, private session: SessionService,) {
    this.dataSource = new CustomStore({
        key: 'risk_admin_likeoccfact_id',
        load: () => this.sendRequest(URL + '/risk_admin_likeoccfact/Getrisk_admin_likeoccfact'),
        
        insert: (values) => this.sendRequest(URL + '/risk_admin_likeoccfact/Insertrisk_admin_likeoccfact', 'POST', {
            // values: JSON.stringify(values)
            values
        }),
        update: (key, values) => this.sendRequest(URL + '/risk_admin_likeoccfact/Updaterisk_admin_likeoccfact', 'PUT', {
             key,values
         }),
         remove: (key) => this.sendRequest(URL + '/risk_admin_likeoccfact/Deleterisk_admin_likeoccfact', 'DELETE', {
             key
         })
    });
...
data.setValue(event.value);
 ...
 // alert(JSON.stringify(data))
    this.riskCatlev.risk_admin_likeoccfact_id=0;
    
     this.params(data);
   }
   
   updateParameters(data:any={}){
   this.riskCatlev.risk_admin_likeoccfact_id=data.key;
   ...
   // this.riskCatlev.risk_natureof_cont_occu_id=data.values.risk_natureof_cont_occu_id;
    this.riskCatlev.risk_admin_likeoccfact_name=data.values.risk_admin_likeoccfact_name;
    this.riskCatlev.risk_admin_likeoccfact_desc=data.values.risk_admin_likeoccfact_desc;
