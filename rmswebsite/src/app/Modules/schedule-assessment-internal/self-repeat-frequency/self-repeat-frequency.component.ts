...
@Component({
  selector: 'app-self-repeat-frequency',
  templateUrl: './self-repeat-frequency.component.html',
  styleUrls: ['./self-repeat-frequency.component.scss'],
  template: `
...
export class SelfRepeatFrequencyComponent {
      ...
      if (this.AssessmentForm.valid) {
       ...
       //const Exemptionuserdata: number[] = this.AssessmentForm.value.exemptionUser?.map((user: any) => user.usR_ID) || [];
        ...
        //  alert(JSON.stringify(formData));
         ...
         this.http.post(URL + '/SetAssessment/insertSelfRepeatFrequency',formData)
         ...
         .subscribe((response: any) => {
           ...
           const message = "Self Repeat Frequency Data Saved Successfully.";
           const dialogErrorRef = this.dialog.open(DaidailogeComponent, {
             width: '550px',
             data: { message: message},
       ...
       const formData = {
        ...
        this.http.post(URL + '/SetAssessment/insertSelfOnetimeFrequency',formData).subscribe((response: any) => {
