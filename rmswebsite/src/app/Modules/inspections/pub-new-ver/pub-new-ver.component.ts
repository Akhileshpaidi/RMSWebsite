...
@Component({
  selector: 'app-pub-new-ver',
  templateUrl: './pub-new-ver.component.html',
  styleUrls: ['./pub-new-ver.component.scss'],
  changeDetection : ChangeDetectionStrategy.OnPush
})
export class PubNewVerComponent implements OnInit, AfterViewInit {
  ...
  gridColumns:any = [
    ...
    { dataField: 'docTypeName', caption: 'Document Type' },
    { dataField: 'doc_CategoryName', caption: 'Category' },
    { dataField: 'doc_SubCategoryName', caption: 'Subcategory' },
    { dataField: 'versionControlNo', caption: 'Version No.' },
    { dataField: 'publisher_name', caption: 'Name of Publisher' },
    ...
    {dataField: 'keywords_tags', caption: 'Keywords',  visible: false},
    { dataField: 'authorityTypeName', caption: 'Authority Type' },
    { dataField: 'authorityName', caption: 'Authority Name' },
    { dataField: 'natureOf_Doc_Name', caption: 'Document Classification' },
    {
...
constructor(private InspectionservicesService: InspectionservicesService,
...
this.entitid=EntityMasterid;
//alert('Entity Master id:'+ EntityMasterid)
//UnitLocationId
...
this.unitid=UnitlocationMasterid;
//alert('Unit location Master_id:'+ UnitlocationMasterid);
//UserId
...
this.form = this.formBuilder.group(formControls1);


//Time_period,indicative_reading_time,publisher_comments,pub_doc
//freq_period_type,freq_period,review_start_Date
  this.form =  this.formBuilder.group ({
   ...
   Doc_Confidentiality: ['', Validators.required],
    ...
    Doc_Inter_ver_num: [''],
      ...
      OtpMethod:[''],
      // Doc_referenceNo:['',Validators.required],
      // Revision_summary:['',Validators.required],
...
.subscribe((data:any)=>{
  this.erroMessage ="Document Version Changed Successfully";
...
// this.http.post(URL + '/AddDocument/UpdateversionchangeDoc', this.versionChangeinfo)
// .subscribe(
//   (response: any) => {
...
if(this.isdoclinkpanelVisible==true){
  ...
  for (let i = 0; i < optionsArray.length; i++) {
    ...
    //this.formData.append(`Revision_summary[${i}].value`, optionValue.value);
