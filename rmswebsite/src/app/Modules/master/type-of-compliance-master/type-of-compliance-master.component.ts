...
@Component({
  selector: 'app-type-of-compliance-master',
  templateUrl: './type-of-compliance-master.component.html',
  styleUrls: ['./type-of-compliance-master.component.scss']
})

export class TypeOfComplianceMasterComponent {
  dataSource: any;
 ...
 //  // SectorModelinfo:sectorModel=new SectorModel();
   ...
   constructor(private http: HttpClient, private session: SessionService) {
     this.dataSource = new CustomStore({
         ...
         load: () => this.sendRequest(URL + '/Compliance/GetComplianceDetails'),
         
         insert: (values) => this.sendRequest(URL + '/Compliance/InsertComplianceDetails', 'POST', {
             //values: JSON.stringify(values)
             values
         }),
         update: (key, values) => this.sendRequest(URL + '/Compliance/UpdateComplianceDetails', 'PUT', {
              key,
              //values: JSON.stringify(values)
             values
          }),
          remove: (key) => this.sendRequest(URL + '/Compliance/DeleteComplianceDetails', 'DELETE', {
              key
          })
     });
