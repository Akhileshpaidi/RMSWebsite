...
@Component({
  selector: 'app-supadmin-view-actrules-regulations',
  templateUrl: './supadmin-view-actrules-regulations.component.html',
  styleUrls: ['./supadmin-view-actrules-regulations.component.scss']
})
export class SupadminViewActrulesRegulationsComponent {
  rulename:any;
...
getRules(event: any) {
 ...
 getactruledata(selectedactrule: any) {
    ...
    //alert(JSON.stringify(this.act_rule_regulatory_id))
    this.http.get(URL + '/SupAdmin_ActRegulatory/superadminGetactruleregulationsDetailsnyid/' + this.act_rule_regulatory_id, { headers })
      .subscribe(
        (res: any) => {
          this.act_rule = res;
  ...
  //  alert(actruleid)
    ...
    this.router.navigate(['dashboard/SuperAd_Common_Entity/supadmin-Edit-actrules-regulations'], {
