...
@Component({
  selector: 'app-supadmin-statutory-forms',
  templateUrl: './supadmin-statutory-forms.component.html',
  styleUrls: ['./supadmin-statutory-forms.component.scss']
})
export class SupadminStatutoryFormsComponent {
  yourform: FormGroup;
  addstatutory:any;
  actname: any;
  rulename: any;
...
userdata:any;
 ...
 // alert(JSON.stringify(formData))
    ...
    // }
        ...
        this.http.post(URL + '/SupAdmin_statutoryfrom/Insertstatutoryfromdetails', formData,{headers})
