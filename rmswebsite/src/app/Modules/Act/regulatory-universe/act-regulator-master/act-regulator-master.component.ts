...
@Component({
  selector: 'app-act-regulator-master',
  templateUrl: './act-regulator-master.component.html',
  styleUrls: ['./act-regulator-master.component.scss']
})
export class ActRegulatorMasterComponent {
  yourform: FormGroup;
  actForm: any;
...
onSubmit() {
  if (this.actForm.valid) {
    ...
    this.http.post(URL + '/ActRegulatory/InsertActRegulatory', formData)
