...
@Component({
  selector: 'app-supadmin-business-sector-list',
  templateUrl: './supadmin-business-sector-list.component.html',
  styleUrls: ['./supadmin-business-sector-list.component.scss']
})
export class SupadminBusinessSectorListComponent {
  dataSource: any;
  ...
  constructor(private http: HttpClient, private session: SessionService,) {
    this.dataSource = new CustomStore({
        ...
        load: () => this.sendRequest(URL + '/SuperAdminBusinessSectorList/GetBusinessSectorListDetails'),
        
        insert: (values) => this.sendRequest(URL + '/SuperAdminBusinessSectorList/InsertBusinessSectorListDetails', 'POST', {
            // values: JSON.stringify(values)
            values
        }),
        update: (key, values) => this.sendRequest(URL + '/SuperAdminBusinessSectorList/UpdateBusinessSectorListDetails', 'PUT', {
             key,
            //  values: JSON.stringify(values)
            values
         }),
         remove: (key) => this.sendRequest(URL + '/SuperAdminBusinessSectorList/DeleteBusinessSectorListDetails', 'DELETE', {
             key
         })
    });
