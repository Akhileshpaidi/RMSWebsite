...
export interface Employee {
  ...
  task_id: Number,
  DocType_Status: String,
  Doctype_CreatedDate: String,
 
}

const employees: Employee[] = [{
  "DocTypeID": 1,
  "DocTypeName": "Nancy Davolio",
  "DocTypeDescription": "Sales Representative",
  "task_id": 2,
  "Doctype_CreatedDate": "1968-12-08T00:00:00.000Z",
  "DocType_Status": "Sales Representative",
//   }, {
//   "EmployeeID": 2,
