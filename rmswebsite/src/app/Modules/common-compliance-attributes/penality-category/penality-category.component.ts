...
@Component({
  selector: 'app-penality-category',
  templateUrl: './penality-category.component.html',
  styleUrls: ['./penality-category.component.scss']
})
export class PenalityCategoryComponent {
  dataSource: any;
  ...
  constructor(private http: HttpClient, private session: SessionService) {
    this.dataSource = new CustomStore({
        ...
        load: () => this.sendRequest(URL + '/penaltycategory/GetpenaltycategoryDetails'),
        
        insert: (values) => this.sendRequest(URL + '/penaltycategory/InsertpenaltycategoryDetails', 'POST', {
            // values: JSON.stringify(values)
            values
        }),
        update: (key, values) => this.sendRequest(URL + '/penaltycategory/UpdatepenaltycategoryDetails', 'PUT', {
             key,
            //  values: JSON.stringify(values)
            values
         }),
         remove: (key) => this.sendRequest(URL + '/penaltycategory/DeletepenaltycategoryDetails', 'DELETE', {
             key
         })
    });
