...
@Component({
  selector: 'app-supadmin-industry-type-list',
  templateUrl: './supadmin-industry-type-list.component.html',
  styleUrls: ['./supadmin-industry-type-list.component.scss']
})
export class SupadminIndustryTypeListComponent {
  dataSource: any;
  typedata:any;
  ...
  constructor(private http: HttpClient, private session: SessionService) {
    this.dataSource = new CustomStore({
        key: 'industrytypeid',
        load: () => this.sendRequest(URL + '/SuperAdminIndustryTypeList/GetIndustryTypeListDetails'),
        
        insert: (values) => this.sendRequest(URL + '/SuperAdminIndustryTypeList/InsertAdminIndustryTypeListDetails', 'POST', {
            // values: JSON.stringify(values)
            values
        }),
        update: (key, values) => this.sendRequest(URL + '/SuperAdminIndustryTypeList/UpdateIndustryTypeListDetails', 'PUT', {
             key,
            //  values: JSON.stringify(values)
            values
         }),
         remove: (key) => this.sendRequest(URL + '/SuperAdminIndustryTypeList/DeleteIndustryTypeListDetails', 'DELETE', {
             key
         })
    });
    this.typedata={
