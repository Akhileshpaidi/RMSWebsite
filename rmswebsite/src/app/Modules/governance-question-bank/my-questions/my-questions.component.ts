...
(this.questionForm.get('options') as FormArray).push(optionFormGroup); // Add the FormGroup to the FormArray
  ...
  options.forEach((option: any) => {
    ...
    this.options.push(optionFormGroup);
         ...
         // this.questionForm.controls['Keyword'].setValue(this.tags.map(tag => tag.name)); // Setting the form control
          } else {
            //this.questionForm.controls['Keyword'].setValue(['']); // Set to an empty array if no keywords
          }
