import {  BusinessSubProcessL3 } from 'src/app/inspectionservices.service';
...
@Component({
  selector: 'app-risk-business-sub-processl3',
  templateUrl: './risk-business-sub-processl3.component.html',
  styleUrls: ['./risk-business-sub-processl3.component.scss']
})
export class RiskBusinessSubProcessl3Component {
  dataSource:any;
  typedata:any;
  typedata2:any;
  typedata3:any;
  ...
  Department:any;
  Function:any;
  Buinessinfo:BusinessSubProcessL3=new BusinessSubProcessL3();
  
  constructor(private http: HttpClient, private session: SessionService) {
    this.dataSource = new CustomStore({
      key: 'businessProcessL2ID',
    
      load: () => this.sendRequest1(URL + '/BusinessSubProcessL3/GetBusinessSubProcesssL3'),
      
      insert: (values) => this.sendRequest1(URL + '/BusinessSubProcessL3/InsertBusinessSubProcessL3', 'POST', {
          // values: JSON.stringify(values)
          values
      }),
      update: (key, values) => this.sendRequest1(URL + '/BusinessSubProcessL3/UpdateBusinessSubProcessL3', 'PUT', {
           key,
          //  values: JSON.stringify(values)
          values
       }),
       remove: (key) => this.sendRequest1(URL + '/BusinessSubProcessL3/DeleteBusinessSubProcessL3', 'DELETE', {
           key
       })
...
getunitlocation(event: any) {
  ...
  insertParameters(data:any={}){
    ...
    this.Buinessinfo.businessProcessL3ID=0;
    this.params(data);
   }
   
   updateParameters(data:any={}){
   this.Buinessinfo.businessProcessL3ID=data.key;
   ...
   params(data:any={}){
    ...
    this.Buinessinfo.businessProcessL2ID =data.values.businessProcessL2ID;
     this.Buinessinfo.businessSubProcessL3Name =data.values.businessSubProcessL3Name;
     this.Buinessinfo.businessSubProcessL3Description =data.values.businessSubProcessL3Description;
     this.Buinessinfo.subProcessObjestiveL3 =data.values.subProcessObjestiveL3;
