...
import { ChangeDetectionStrategy, ChangeDetectorRef, ElementRef, OnInit } from '@angular/core';
...
@Component({
  selector: 'app-customized-assessment',
  templateUrl: './customized-assessment.component.html',
  styleUrls: ['./customized-assessment.component.scss']
})

export class CustomizedAssessmentComponent implements OnInit{
...
gridColumnsNew: any[] = [
  ...
  ,
  {dataField:'authorName',caption: 'Author Name'},{dataField:'entity',caption:'Entity'},{dataField:'location',caption:'Location'},{dataField:'departmentName',caption:'Department'},{dataField:'tpaentity',caption: 'TPA Entity'},
  {
    dataField: 'estimated_time',
    caption: 'Estimated Time(in Minutes)',
       alignment: 'center'
...
containerColumnsNew: any[] = [
  ...
  {dataField:'authorName',caption: 'Author Name'},{dataField:'entity',caption:'Entity'},{dataField:'location',caption:'Location'},{dataField:'departmentName',caption:'Department'},
  {
    dataField: 'estimated_time',
    caption: 'Time estimate to answer Question(in Minutes)'
  },
...
store: new CustomStore({
    ...
    loadMode: 'raw',
    load:()=>{return new Promise((resolve, reject) => {
      this.http.get(URL + '/AssessmentBuilder/GetQuestions/'+Userid,{headers})
        .subscribe(res => {
         (resolve(res));
...
publishPreview(event: Event, stepper: MatStepper): void {
  // Perform any additional logic before publishing, if needed
  // ...

  // Publish logic (you can call your existing PublishAssBuilder method here)
  ...
  if(e.value=="My Questions"){
    ...
    this.GetAllQuestions={
      ...
      store: new CustomStore({
          ...
          loadMode: 'raw',
          load:()=>{return new Promise((resolve, reject) => {
            this.http.get(URL + '/QuestionBank/GetActiveQuestionsbyentityid/'+this.Useridvalue,{headers})
              .subscribe((res:any) => {
               (resolve(res));
