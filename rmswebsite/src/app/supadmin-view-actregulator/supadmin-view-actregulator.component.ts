...
@Component({
  selector: 'app-supadmin-view-actregulator',
  templateUrl: './supadmin-view-actregulator.component.html',
  styleUrls: ['./supadmin-view-actregulator.component.scss']
})
export class SupadminViewActregulatorComponent {
  actname:any;
  actregulatoryid:any;
  act:any;
...
getRules(selectedactrule: any) {
  ...
  this.http.get(URL + '/superadminactregulations/superadminGetactregulationsDetailsnyid/' + this.actregulatoryid, { headers })
    .subscribe(
      (res: any) => {
        this.act = res;
...
editAct(actregulatoryid: number) {
 ...
 // alert(actregulatoryid)
  ...
  this.router.navigate(['dashboard/SuperAd_Common_Entity/supadmin-edit-actregulator'], {
