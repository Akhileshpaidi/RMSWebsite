...
@Component({
  selector: 'app-view-company-compliance',
  templateUrl: './view-company-compliance.component.html',
  styleUrls: ['./view-company-compliance.component.scss']
})
export class ViewCompanyComplianceComponent {
      ...
      store: new CustomStore({
        ...
        load: () => {
          return new Promise((resolve, reject) => {
            this.http.get(URL + '/createcompanycompliance/GetGlobalComplianceDetails', { headers })
              .subscribe(res => {
...
this.pharameters = e.create_compliance_id;
            ...
            this.http.get(URL + '/createcompanycompliance/GetSelectedGlobalComplianceDetailsByID/'+this.pharameters, { headers })
              .subscribe((res:any) => {
