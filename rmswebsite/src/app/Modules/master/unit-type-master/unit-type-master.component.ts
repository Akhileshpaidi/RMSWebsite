...
@Component({
  ...
  styleUrls: ['./unit-type-master.component.scss']
})
export class UnitTypeMasterComponent {
  dataSource: any;
  userdata: any;
  createdBy: any;
 ...
 // SectorModelinfo:sectorModel=new SectorModel();
  ...
  constructor(private http: HttpClient, private session: SessionService) {
    this.dataSource = new CustomStore({
        ...
        key: 'unitTypeID',
        load: () => this.sendRequest(URL + '/UnitType/GetUnitTypeMasterDetails'),
        
        insert: (values) => this.sendRequest(URL + '/UnitType/InsertUnitTypeMasterDetails', 'POST', {
            //values: JSON.stringify(values)
            values
        }),
        update: (key, values) => this.sendRequest(URL + '/UnitTypeMaster/UpdateUnitTypeMasterDetails', 'PUT', {
             key,
             //values: JSON.stringify(values)
            values
         }),
         remove: (key) => this.sendRequest(URL + '/UnitTypeMaster/DeleteUnitTypeMasterDetails', 'DELETE', {
             key
         })
    });
  }
