...
@Component({
  selector: 'app-published-doc-list',
  templateUrl: './published-doc-list.component.html',
  styleUrls: ['./published-doc-list.component.scss']
})
export class PublishedDocListComponent {
  ...
  let adjustDate = (date: Date | null | undefined) => date ? new Date(date.getTime() - date.getTimezoneOffset() * 60000).toISOString().split('T')[0] : null;
    ...
    this.dataSource1 = new CustomStore({
        ...
        load: () => {
            ...
            return this.sendRequest1(URL + '/GovControlReportsController/GetPubDocList', formData)
                .then(response => {
