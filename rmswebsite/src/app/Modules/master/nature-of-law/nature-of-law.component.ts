...
@Component({
  selector: 'app-nature-of-law',
  templateUrl: './nature-of-law.component.html',
  styleUrls: ['./nature-of-law.component.scss']
})
export class NatureOfLawComponent {
  dataSource: any;
 ...
 // SectorModelinfo:sectorModel=new SectorModel();
  ...
  constructor(private http: HttpClient, private session: SessionService) { 
    this.dataSource = new CustomStore({
        ...
        key: 'law_type_id',
        load: () => this.sendRequest(URL + '/LawType/GetLawTypeDetails'),
        
        insert: (values) => this.sendRequest(URL + '/LawType/InsertLawTypeDetails', 'POST', {
            //values: JSON.stringify(values)
            values
        }),
        update: (key, values) => this.sendRequest(URL + '/LawType/UpdateLawTypeDetails', 'PUT', {
             key,
             //values: JSON.stringify(values)
            values
         }),
         remove: (key) => this.sendRequest(URL + '/LawType/DeleteLawTypeDetails', 'DELETE', {
             key
         })
    });
  }
