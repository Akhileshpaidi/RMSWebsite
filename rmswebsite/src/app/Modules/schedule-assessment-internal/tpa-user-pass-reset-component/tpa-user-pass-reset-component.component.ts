...
@Component({
  selector: 'app-tpa-user-pass-reset-component',
  templateUrl: './tpa-user-pass-reset-component.component.html',
  styleUrls: ['./tpa-user-pass-reset-component.component.scss']
})
export class TpaUserPassResetComponentComponent {
  submitted = false;
  ...
  ngOnInit() {
   ...
   console.log(this.id.defaultValue, 'tpauserid');
  }
  ...
  forgotPass(data: any): void {
    ...
    let payload = {
      ...
      mode: 'P',
      tpauserid: this.id.defaultValue,
    ...
    this.http.put(URL + '/updatetpauserDetails/UpdatecreateusertpapasswordDetails/', payload,{headers })
    .subscribe({
        next: (response: any) => {
