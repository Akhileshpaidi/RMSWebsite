...
@Component({
  selector: 'app-supadmin-regulatory-authority',
  templateUrl: './supadmin-regulatory-authority.component.html',
  styleUrls: ['./supadmin-regulatory-authority.component.scss']
})
export class SupadminRegulatoryAuthorityComponent {
  dataSource: any;
  ...
  constructor(private http: HttpClient, private session: SessionService) {
    this.dataSource = new CustomStore({
        ...
        load: () => this.sendRequest(URL + '/SupAdmin_RegulatoryAuthority/GetRegulatoryAuthorityDetails'),
        
        insert: (values) => this.sendRequest(URL + '/SupAdmin_RegulatoryAuthority/InsertRegulatoryAuthorityDetails', 'POST', {
            // values: JSON.stringify(values)
            values
        }),
        update: (key, values) => this.sendRequest(URL + '/SupAdmin_RegulatoryAuthority/UpdateRegulatoryAuthorityDetails', 'PUT', {
             key,
            //  values: JSON.stringify(values)
            values
         }),
         remove: (key) => this.sendRequest(URL + '/SupAdmin_RegulatoryAuthority/DeleteRegulatoryAuthorityDetails', 'DELETE', {
             key
         })
    });
