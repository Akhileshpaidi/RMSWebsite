...
@Component({
  selector: 'app-addnewquestions',
  templateUrl: './addnewquestions.component.html',
  styleUrls: ['./addnewquestions.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class AddnewquestionsComponent implements OnInit {

@Output() messageEvent = new EventEmitter<{flag: boolean, message: string}>();
...
if(correctanswer==''||null){
 ...
 const dialogErrorRef = this.dialog.open(DaidailogeComponent, {
   ...
   data: { message: message},
       ...
       this.messageEvent.emit({flag: this.exitValue, message: "Update"});
      },
      (error: any) => {
...
exitPage(){
  setTimeout(()=>{
    this.messageEvent.emit({flag: this.exitValue, message: "Edit"});
